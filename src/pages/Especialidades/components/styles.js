...
export const ModalContainer = styled.div`
  ...
  h2 { 
    color: ${({ theme }) => theme.colors.primary}; /* Trocado de primaryDark para não sumir no modo escuro */
...
export const FormGroup = styled.div`
  ...
  input {
    ...
    border-radius: 4px;
    background-color: ${({ theme }) => theme.colors.inputBg}; /* Adaptação para o dark mode */
...
export const ButtonGroup = styled.div`
  ...
  button {
    ...
    &.cancel { 
      ...
      color: ${({ theme }) => theme.colors.text}; 
      border: 1px solid ${({ theme }) => theme.colors.border}; /* Borda para demarcar o botão de cancelar */
    }
